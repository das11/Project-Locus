package kdas.i_nterface.maps_test;
...
//##################################################################################################
//
// Fall back perm. handler function
//    @Override
...
//            PermissionUtils.requestPermission(this, 11,
...
//                != PackageManager.PERMISSION_GRANTED) {
//            // Permission to access the location is missing.
//            PermissionUtils.requestPermission(this, 12,
//                    Manifest.permission.ACCESS_FINE_LOCATION, true);
...
//    }
//######################
//    private void enableLocationServices2() {
//        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
//                != PackageManager.PERMISSION_GRANTED) {
//            // Permission to access the location is missing.
//            PermissionUtils.requestPermission(this, 13,
//                    Manifest.permission.ACCESS_FINE_LOCATION, true);
//        } else if (location != null) {
//            // Access to the location has been granted to the app.
//            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, this);
